...
(*mark_debug = "true"*)wire [`LID         -1 :0] cpu_awid;
(*mark_debug = "true"*)wire [`Lawaddr     -1 :0] cpu_awaddr;
(*mark_debug = "true"*)wire [`Lawlen      -1 :0] cpu_awlen;
wire [`Lawsize     -1 :0] cpu_awsize;
(*mark_debug = "true"*)wire [`Lawburst    -1 :0] cpu_awburst;
...
(*mark_debug = "true"*)wire                      cpu_wlast;
(*mark_debug = "true"*)wire                      cpu_wvalid;
(*mark_debug = "true"*)wire                      cpu_wready;
(*mark_debug = "true"*)wire [`LID         -1 :0] cpu_bid;
wire [`Lbresp      -1 :0] cpu_bresp;
(*mark_debug = "true"*)wire                      cpu_bvalid;
wire                      cpu_bready;
(*mark_debug = "true"*)wire [`LID         -1 :0] cpu_arid;
(*mark_debug = "true"*)wire [`Laraddr     -1 :0] cpu_araddr;
(*mark_debug = "true"*)wire [`Larlen      -1 :0] cpu_arlen;
wire [`Larsize     -1 :0] cpu_arsize;
(*mark_debug = "true"*)wire [`Larburst    -1 :0] cpu_arburst;
wire [`Larlock     -1 :0] cpu_arlock;
wire [`Larcache    -1 :0] cpu_arcache;
wire [`Larprot     -1 :0] cpu_arprot;
(*mark_debug = "true"*)wire                      cpu_arvalid;
(*mark_debug = "true"*)wire                      cpu_arready;
(*mark_debug = "true"*)wire [`LID         -1 :0] cpu_rid;
wire [`Lrdata      -1 :0] cpu_rdata;
wire [`Lrresp      -1 :0] cpu_rresp;
(*mark_debug = "true"*)wire                      cpu_rlast;
(*mark_debug = "true"*)wire                      cpu_rvalid;
(*mark_debug = "true"*)wire                      cpu_rready;
...
mycpu_top #(
    ...
    .CTRL_CLO_CLZ(1'b1),
    .CTRL_TRAP_UNIT(1'b1),
    .CTRL_USE_XPM_CPC(1'b0),
    .CTRL_EXTEND_INST_SET(1'b1),
    .CTRL_XBAR_USE_IP(1'b1),
    .CTRL_PLRU_ENABLE(1'b1),
    .CTRL_IPREF_ENABLE(1'b1),
    .CTRL_DPREF_ENABLE(1'b1)
)  cpu_mid (
  .aclk         (cpu_clk),
